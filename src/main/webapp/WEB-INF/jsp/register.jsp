                    ...
                    <form role="form" method="post" action="/register">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input id="name" class="form-control input-lg" placeholder="昵称" name="name" type="text" autofocus>
                            </div>
                            <div class="col-md-12" id="error_name"></div>
                            <div class="form-group">
                                <label for="email"><span class="glyphicon glyphicon-envelope"></span>&nbsp;邮箱</label>
                                <input id="email" class="form-control input-lg" placeholder="邮箱" name="email" type="email" autofocus>
                            </div>
                            <div class="col-md-12" id="error_email"></div>
                            <div class="form-group">
                                <label for="phone"><span class="glyphicon glyphicon-phone"></span>&nbsp;手机</label>
                                <input id="phone" class="form-control input-lg" placeholder="手机" name="phone" type="text" autofocus>
                            </div>
                            ...
                            <div class="col-md-12" id="error_password">asdasd</div>
                            <div class="form-group">
                                <label for="repassword"><span class="glyphicon glyphicon-lock"></span>&nbsp;确认密码</label>
                                <input id="repassword" class="form-control input-lg" placeholder="确认密码" name="repassword" type="password" value="">
                            </div>
                            <div class="col-md-12" id="error_repassword"></div>
                            <input type="submit" value="注册"  class="btn btn-lg btn-success btn-block"></input>
                        </fieldset>
                    </form>
                </div>
            </div>

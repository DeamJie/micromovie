package cn.edu.nsu.micromovie.util.security;
...
import cn.edu.nsu.micromovie.util.security.ext.UnionAesSecureRandom;
 ...
 */
public class AES {
	private static String strDefaultKey = "venutech_dsm3";
	private String key;

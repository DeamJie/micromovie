...
public class HandleResult implements Serializable {
	...
	public static HandleResult result(boolean result){
		return result ? HandleResult.success() : HandleResult.error();
	}
	
	public static HandleResult result(boolean result, String errorInfo){
		return result ? HandleResult.success() : HandleResult.error(errorInfo);
	}
